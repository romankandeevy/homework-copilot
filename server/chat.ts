...
// 20 000 символов — втрое больше самого длинного ответа из замера 30 августа
// (6838 символов на просьбу разобрать тему за 10 класс с примерами), то есть
// живого ответа обрезка не касается. Прежние 60 000 были взяты на глаз и
// ломали расчёт резерва: резерв обязан покрывать ответ предельной длины,
// а под книгу на 60 000 символов пришлось бы блокировать десятки рублей.
