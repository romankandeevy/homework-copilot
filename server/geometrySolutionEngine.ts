...
const authorInstructions = [
  ...
  'В explanation четыре роли строк, по одной мысли на строку. Первая: правило или идея, на которых держится решение, и откуда это правило берётся. Вторая: по какому признаку такую задачу узнать в следующий раз. Третья: где здесь чаще всего ошибаются. Четвёртая: как самому проверить, что ответ верный.',
