...
1. Inspect the page goal, audience, offer/product reality, source copy, proof, IA, forms, SEO/social metadata, brand voice, and verification commands.
2. Read [Content Pruning Review Guide](references/content-pruning-review-guide.md) before changing headings, sections, CTAs, metadata, labels, or UI copy.
...
5. Inspect the rendered page on desktop and mobile for hierarchy, wrapping, repetition, and whether copy still matches the UI.
