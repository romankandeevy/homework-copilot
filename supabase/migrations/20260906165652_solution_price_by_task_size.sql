...
--
-- Применена 6 сентября. Сверка формулы с зеркалом в TypeScript на живой
-- базе: история 120 знаков - 400, алгебра 200 - 500, геометрия со снимком -
-- 600, физика 1400 знаков и снимок 900 КБ - 800, потолок - 1200.
--
