...
test('task 3 never renders a made-up triangle and fits on one sheet', async ({ page }, testInfo) => {
  ...
  await expect(page.getByText('Ответ: 3 точки или 1 точка')).toBeVisible()
