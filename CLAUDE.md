...
Оформление листа по всем предметам без вызова модели - `http://localhost:5173/?sheets=1`
(только в разработке): четырнадцать записей аудита 15 сентября из
`src/notebook/auditFixtures.ts`.
