    ...
    try {
      ...
      const submitted = await onSubmit({
        ...
        /* Есть фотография - значит задача с фотографии, что бы ученик ни
           ...
           Раньше источником считался текст, если он вообще был. 6 сентября
           на проде ученик приложил снимок задачи по физике и подписал
           «Решить задачу 1 про образование воды». Запрос ушёл как текстовый,
           и эта подпись поехала в промпт как «проверенное условие»: модель
           разбирала строчку из шести слов, а не задачу со снимка. Вышел
           словесный абзац без «Дано», проверка его отвергла, ученик прочёл
           «Решение не дошло».

           Текст рядом с фотографией - пометка, а не условие. */
