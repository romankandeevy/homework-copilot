...
export default function SupportAdminPanel({ preview = false }: { preview?: boolean }) {
  ...
  const creditFeature = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (creditError) setError('Не получилось начислить баланс.')
    else {
