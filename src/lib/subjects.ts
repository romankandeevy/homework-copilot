...
/* Ступени обучения.
   ...
   Класс - не украшение формы: он определяет, каким приёмом задачу можно
   решать. 7 сентября на проде стереометрия за 11 класс вышла через
   векторное и смешанное произведение - ответ верный, а сдать нельзя:
   в школе этого не проходят (см. server/gradeRules.ts).

   «Университет» стоит здесь потому, что задачи приносят и студенты, и для
   них ограничения школьной программы бессмысленны. */
export const solvableGrades = [
  '5 класс', '6 класс', '7 класс', '8 класс', '9 класс', '10 класс', '11 класс', 'Университет',
] as const
