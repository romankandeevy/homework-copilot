...
// Тот же адрес, что в документах и подвале: одна константа в src/lib/seller.ts.
...
const faqs = [
  ...
  { question: 'Как работают приглашения?', answer: 'В разделе баланса у каждого есть личная ссылка. Как только новый пользователь зарегистрируется по ней и подтвердит почту или номер телефона, пригласившему начислят 10 ₽, а приглашённому — 5 ₽. Пополнять баланс для этого не нужно. Для существующих аккаунтов бонус не действует.' },
  ...
  { question: 'Можно ли восстановить доступ к аккаунту?', answer: 'Если аккаунт создан по почте, используй «Не помню пароль» в окне входа. У аккаунта по номеру телефона пароля нет: войди заново по коду из СМС на тот же номер. Если не выходит ни так, ни так, напиши на ' + supportEmail + ' и укажи почту или номер телефона аккаунта.' },
]
