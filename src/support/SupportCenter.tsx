...
const faqs = [
  { question: 'Как получить решение задачи?', answer: 'Впиши условие на главной или приложи фотографию задачи и нажми «Решить». Предмет и класс указывать необязательно — их определит модель. Готовое решение останется в разделе «Мои решения».' },
