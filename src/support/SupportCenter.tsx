...
const faqs = [
  ...
  { question: 'Почему баланс изменился?', answer: 'В истории аккаунта видны все списания и начисления. Решение задачи стоит одинаково для любого предмета и для обоих способов ввода — цена показана над формой до запуска. Ответ в ИИ-чате списывается отдельно и по факту.' },
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="site-footer-meta">
        ...
        <span>Решения помогают разобраться, а не заменяют работу над задачей.</span>
      </div>
    </footer>
  )
}
