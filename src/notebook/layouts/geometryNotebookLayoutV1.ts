export const geometryNotebookLayoutV1 = {
  ...
  zones: {
    ...
    diagram: {
      ...
      /* Штриховка опоры, стены и зеркала.

         Рисовалась тремя отдельными копиями с разным шагом, разным началом
         и разным наклоном: на проде 7 сентября штриховка рельсов в задаче
         по электромагнитной индукции вышла вразнобой. Шаг и наклон - здесь,
         как и остальные размеры примитивов. */
      hatch: {
        stepRatio: 0.35,
        lengthRatio: 0.45,
        minimumStrokes: 3,
