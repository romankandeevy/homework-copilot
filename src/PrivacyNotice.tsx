...
export default function PrivacyNotice() {
  ...
  return (
    <aside className="privacy-notice" aria-label="Уведомление о хранении данных">
      ...
      <p><strong>Без рекламных cookie.</strong> Мы сохраняем в браузере только вход, тему, выбранный предмет и твои локальные данные. <a href="/docs/cookies">Как это работает</a></p>
