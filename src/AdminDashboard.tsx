      ...
      {detail && (
        <aside ref={drawerRef} className="admin-user-drawer" role="dialog" aria-modal="true" aria-labelledby="admin-user-drawer-title" tabIndex={-1}>
          ...
          <form className="admin-action-form is-verified-top-up" onSubmit={recordVerifiedTopUp}>
            <header><CurrencyRub size={19} weight="duotone" aria-hidden="true" /><div><h3>Подтвердить пополнение</h3><p>Ручная запись оплаты, которую подтвердил банк. Она же выдаёт реферальные +10 ₽ и +5 ₽, если приглашение ещё не оплачено.</p></div></header>
