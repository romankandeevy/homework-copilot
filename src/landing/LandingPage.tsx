...
const heroMarks = [
  ...
  { value: '14 предметов', note: '5-11 класс и университет' },
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Первое решение выдаётся без аккаунта - просто впиши условие и нажми «Решить». Аккаунт нужен со второго: решение привязывается к балансу и остаётся в истории. Войти можно по почте, а если в окне входа есть такие кнопки - по номеру телефона или через Яндекс ID. Новому аккаунту сразу начисляются 20 ₽ - один раз на устройство, это пять задач по минимальной цене.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Обычно 15-70 секунд: задача уходит одним проходом сильной модели, а запись проверяется кодом по правилам предмета. Страницу можно закрыть - решение сохранится. С аккаунтом оно ждёт в «Моих решениях», без аккаунта - в очереди на странице «Решить задачу», шесть часов после готовности.',
  },
  {
          ...
          <div className="landing-shell hero-shell">
            <div className="hero-copy">
              ...
              <p className="hero-lead">
                ...
                для тетради: дано, ход решения, чертёж, ответ. 14 предметов,
                5-11 класс и университет, учебник неважен.
              </p>
              ...
              {/* «Регистрация нужна со второй задачи» снята 16 сентября 2026:
                  строкой ниже `hero-marks` говорит то же - «Бесплатно, первая
                  задача, без регистрации», и обещание первого экрана звучало
                  дважды (аудит, Г9). */}
          ...
          <div className="landing-shell">
            ...
            <Reveal className="subject-band" delay={60}>
              <div className="subject-band-head">
                <h3>14 предметов, 5-11 класс и университет</h3>
              ...
              <Reveal className="price-side" delay={80}>
                <ul className="price-list">
                  ...
                  <li>
                    ...
                    <span><strong>Приглашение друга</strong><small>Как только он зарегистрируется по ссылке и подтвердит почту или номер телефона: ему 5&nbsp;₽, тебе 10&nbsp;₽</small></span>
                    <b>+10&nbsp;₽</b>
                  </li>
                </ul>
        ...
        <section className="landing-section landing-final" aria-labelledby="final-title">
          <div className="landing-shell">
            <Reveal className="final-card">
              ...
              <p>Первое решение - без регистрации. Понравится - заведёшь аккаунт и получишь 20 ₽ на старт, один раз на устройство: это пять задач по минимальной цене.</p>
