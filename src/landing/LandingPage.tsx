...
const steps = [
  {
    ...
    text: 'Фотография с телефона, скриншот из буфера обмена или текст. Предмет и класс можно не выбирать — определим сами.',
  },
  {
    icon: ShieldCheck,
    title: 'Задачу решают дважды',
    text: 'Два независимых прохода разными семействами моделей. Разошлись — подключается третья, рецензент. Не сошлось — решение не выдаём и деньги не списываем.',
  },
  {
