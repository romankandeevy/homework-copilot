...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Первое решение выдаётся без аккаунта - просто впиши условие и нажми «Решить». Аккаунт нужен со второго: решение привязывается к балансу и остаётся в истории. Войти можно через Google или по почте. Новому аккаунту сразу начисляются 20 ₽ - один раз на устройство, это пять задач по минимальной цене.',
  },
  {
